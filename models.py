...
# All users will have a UserModel, which contains varios information about them
...
users = [
    ...
    UserModel(first_name='', last_name='', birth=datetime(1, 1, 1)),
]

# a session is created each time you interact with the database
...
with session_maker() as session:
    ...
    for user in user_records:
        # Goes through all users and prints their names
